...
This folder stores employer-provided project context and scope notes so future sessions can resume quickly.
...
- `raw/02-full-phase-2-scope-and-riipen-submission.txt`
- `raw/03-production-ready-development-blueprint.txt`
- `raw/04-riipen-project-summary-and-deliverables.txt`
